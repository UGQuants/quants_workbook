...
4. Type 'Test1' in the 'Title' section and your name in the 'Author' box. Leave the 'Default Output Format' as `HTML`. Then, click 'OK'.
...
Similarly, you can create a `.pdf` file. To do this, instead of clicking on the _Knit_ icon directly, click on the black arrow next to it. Then click 'Knit to PDF'. Try it and see the result.
