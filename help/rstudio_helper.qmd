...
To be clear, your GenAI use on this course is not limited to RStudio Helper. Instead, it is made available to make it easier to get more useful responses from GenAI. The instructions with explanations are provided on this page, so you can see how to achieve similar with your own prompts.
